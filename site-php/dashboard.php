                    ...
                    <div class="row"> <!--begin::Col-->
                        ...
                        <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 2-->
                            <div class="small-box text-bg-success">
                                ...
                                <a href="<?php echo $base_url?>/formularios.php?form=camaras&token=<?php echo $token;?>" 
                                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                                >
                                    More info 
                                    <i class="bi bi-link-45deg"></i> 
                        ...
                        <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 3-->
                            <div class="small-box text-bg-warning">
                                ...
                                <a href="<?php echo $base_url?>/formularios.php?form=usuarios&token=<?php echo $token;?>" 
                        ...
                        <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 4-->
                            <div class="small-box text-bg-danger">
                                ...
                                <a href="<?php echo $base_url?>/formularios.php?form=plantas&token=<?php echo $token;?>" 
                                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                                >
                                    More info 
                                    <i class="bi bi-link-45deg"></i> 
