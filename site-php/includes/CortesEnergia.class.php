<?php
    ...
    class CortesEnergia{
        public static function create_corteEnergia($id_planta, $id_cliente, $fecha, $observacion,$estado){
            $database = new Database();
            $conn = $database->getConnection();
            $stmt = $conn->prepare('INSERT INTO cctv_reporte_corte_energia (id_planta,id_cliente,fecha,observacion,estado)
