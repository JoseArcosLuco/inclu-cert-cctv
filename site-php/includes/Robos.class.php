<?php
    ...
    class Robos{
        public static function create_robo($id_planta, $id_cliente, $fecha, $observacion,$estado){
            $database = new Database();
            $conn = $database->getConnection();
            $stmt = $conn->prepare('INSERT INTO cctv_reporte_robo (id_planta,id_cliente,fecha,observacion,estado)
        ...
        public static function delete_robo_by_id($id){
            $database = new Database();
            $conn = $database->getConnection();

            $stmt = $conn->prepare('DELETE FROM cctv_reporte_robo WHERE id=:id');
        ...
        public static function get_all_robos(){
            $database = new Database();
            $conn = $database->getConnection();
            $stmt = $conn->prepare('SELECT * FROM cctv_reporte_robo');
            if($stmt->execute()){
                $result = $stmt->fetchAll();
                return $result;
            } else {
